        ...
        public void run(){
            ...
            try {
                while(in != null) {
                    ...
                    if (tx.contains("vote1=true")){
                        String[] dataSplit = tx.split("=");
                        try{
                            String message = vtx.vMessage(dataSplit[2]);
                            out.writeUTF("vote1_done"+ message);
                    ...
                    if(tx.contains("vote2=true")) {
                        String[] dataSplit = tx.split("=");
                        try{
                            String message = vtx.vMessage(dataSplit[2]);
                            socketMap.get("Agent").writeUTF("vote2=true"+message);
                        } catch (Exception e){
                            e.printStackTrace();
                        }
                    }
