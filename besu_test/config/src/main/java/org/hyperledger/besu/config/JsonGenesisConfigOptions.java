...
public class JsonGenesisConfigOptions implements GenesisConfigOptions {
  ...
  private static final String AGENT_CONSENSUS_KEY="agent";
  ...
  public boolean isAgent() {
    return configRoot.has(AGENT_CONSENSUS_KEY);
  }
  ...
  @Override
  public AgentConfigOptions getAgentConfigOptions() {
    return JsonUtil.getObjectNode(configRoot, AGENT_CONSENSUS_KEY)
            .map(AgentConfigOptions::new)
            .orElse(AgentConfigOptions.DEFAULT);
  }
  ...
  public Map<String, Object> asMap() {
    ...
    if (isAgent()){
      builder.put("agent", getAgentConfigOptions().asMap());
    }
