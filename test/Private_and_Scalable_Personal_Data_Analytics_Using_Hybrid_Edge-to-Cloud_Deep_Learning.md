...
본 논문에서도 그림1과 같은 에지 컴퓨팅을 사용하여 개인정보를 보호하는 방법에 대해서 이야기 하고자 합니다.  
...
스마트폰 카메라를 통한 얼굴 인식, 연령 추정, 성별 분류, 감정 감지등을 통한 노출
...
다양한 음성인식 IoT 기기들의 발전으로 인한 음성 노출
...
실제 환경에서는 다양한 방법으로 개인정보가 노출되고 있습니다.

1. 이미지  

스마트폰 카메라를 통한 얼굴 인식, 연령 추정, 성별 분류, 감정 감지등이 가능합니다.
