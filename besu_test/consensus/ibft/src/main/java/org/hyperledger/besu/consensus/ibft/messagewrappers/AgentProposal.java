...
public class AgentProposal extends AgentMessage<AgentProposalPayload> {
    ...
    public AgentProposal(
            final AgentSignedData<AgentProposalPayload> payload,
    ...
    public static AgentProposal decode(final Bytes data) {
        final RLPInput rlpIn = RLP.input(data);
        rlpIn.enterList();
        final AgentSignedData<AgentProposalPayload> payload = AgentSignedData.readSignedProposalPayloadFrom(rlpIn);
        ...
        rlpIn.leaveList();
        return new AgentProposal(payload, proposedBlock, roundChangeCertificate);
    }
